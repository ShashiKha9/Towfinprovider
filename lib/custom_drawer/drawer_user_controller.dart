              ...
              SizedBox(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    boxShadow: <BoxShadow>[
                      BoxShadow(color: AppTheme.grey.withOpacity(0.6), blurRadius: 54),
                    ],
                  ),
                  child: Stack(
                    children: <Widget>[
                      ...
                      Padding(
                        padding: EdgeInsets.only(top: MediaQuery.of(context).padding.top + 8, left: 0),
                        child: SizedBox(
                            ...
                            child: InkWell(
                              ...
                              child: Center(
                                ...
                                child: widget.menuView != null
                                    ? widget.menuView
                                    : AnimatedIcon(
                                        icon: widget.animatedIconData != null ? widget.animatedIconData : AnimatedIcons.close_menu,color: Colors.white,
