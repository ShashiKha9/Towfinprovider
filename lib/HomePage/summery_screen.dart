...
import 'package:cbx_driver/bloc/ProviderSummaryBloc.dart';
...
class _SummaryScreenState extends State<SummaryScreen>
  ...
  Future<void> initPreferences() async {
    ...
    bloc.providerSummaryReq(context, prefs.getString(SharedPrefsKeys.ACCESS_TOKEN),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:       StreamBuilder<SummaryRespo>(
          stream: bloc.subjectProviderSummary.stream,
                        ...
                        if (!snapshot.hasData) {
                          ...
                          return ListView(
                            ...
                            children: <Widget>[
                              ...
                              ListTile(
                                leading: Icon(Icons.emoji_objects_outlined,size: 40,color: AppTheme.colorPrimaryDark,),
                                title: Text('TOTAL NUMBER OF SERVICES',textScaleFactor: 1.2,style: TextStyle(fontFamily: AppTheme.fontName),),

                                trailing: Container(
                                  child:Text(snap.data.rides.toString(),textScaleFactor: 1.2,style: TextStyle(fontFamily: AppTheme.fontName,color: Colors.black),),),
                                subtitle: Text('Your total number of services that you completed recently',textScaleFactor: 0.9,),
                                selected: false,
                              ),
                              SizedBox(
                                height: 10,
                              ...
                              ListTile(
                                leading: Icon(Icons.monetization_on_outlined,size: 40,color: Colors.green,),
                                title: Text('REVENUE',textScaleFactor: 1.2,style: TextStyle(fontFamily: AppTheme.fontName),),

                                trailing: Container(
                                  child:Text('\$'+snap.data.revenue.toString(),textScaleFactor: 1.2,style: TextStyle(fontFamily: AppTheme.fontName,color: Colors.black),),),
                                subtitle: Text('Your total Revenue of services that you earned',textScaleFactor: 0.9,),
                                selected: false,
                              ),
                              SizedBox(
                                height: 10,
                              ...
                              ListTile(
                                leading: Icon(Icons.cancel_outlined,size: 40,color: Colors.red,),
                                title: Text('CANCELLED SERVICES',textScaleFactor: 1.2,style: TextStyle(fontFamily: AppTheme.fontName),),

                                trailing: Container(
                                  child:Text(snap.data.cancelRides.toString(),textScaleFactor: 1.2,style: TextStyle(fontFamily: AppTheme.fontName,color: Colors.black),),),
                                subtitle: Text('Your total number of cancelled services.',textScaleFactor: 0.9,),
                                selected: false,
                              ),                            ],
                          );
